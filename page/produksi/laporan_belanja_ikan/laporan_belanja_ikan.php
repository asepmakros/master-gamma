...
if(!empty($id)){
$sqlubah = $koneksilama->query("select * from tb_laporan_belanja_ikan where id = '$id'");
...
//   }
  ...
  $sql = $koneksilama->query("insert into tb_laporan_belanja_ikan 
  ...
  ?>
      <script type="text/javascript">
          ...
          window.location.href="?page=produksi&aksi=tb_laporan_belanja_ikan";
      </script>
<?php
  }
}
...
if(isset($_POST['ubah'])){
    ...
    $sql_ubah = $koneksilama->query("update tb_laporan_belanja_ikan set
    ...
    ?>
        <script type="text/javascript">
            ...
            window.location.href="?page=produksi&aksi=laporan_produksi";
        </script>
  <?php
    }
  }
...
<table class="table table-sm table-bordered">
  ...
  <tbody>
    <?php 
    $no1=1;
    $sqldata = $koneksilama->query("select * from tb_laporan_belanja_ikan order by id desc limit 100");
