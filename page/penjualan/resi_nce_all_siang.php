...
<?php
$no = 1;
$sqlinvoice = $koneksilama->query("select * from sales where tgl_kirim_fix = '$hari_ini' and pelanggan like 'COD%' and pelanggan like '%NCS%' and gudang != 'y1' group by no_inv");
