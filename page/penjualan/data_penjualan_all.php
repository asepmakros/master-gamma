    ...
    <!-- <h3 class=" fixed-top  text-center">Data Penjualan Ciwidey Food <?= $jenis ?></h3> -->
        ...
        <div class="" style="padding-top: 60px;">
            ...
            <div class="input-group mt-4" >
                ...
                <a href="https://ciwideyfood.com/app/penjualan/data_penjualan.php" class="btn btn-warning">Back</a>
                <input type="text" name="nama" class="form-control text-center" placeholder="Masukkan Pencarian">
        ...
        if(isset($_POST['pilih'])){
            $nama = $_POST['nama'];
            echo 'Pencarian kata kunci "'.$nama.'"';
            $sql = $koneksilama->query("select * from sales 
            where no_hp != '' and pelanggan like '%$nama%' or alamat like '%$nama%'
            group by no_inv order by id desc ");
           
      
?>
<div class="table-responsive">
        <table id="" class="table table-sm table-striped display">
                <thead>
                ...
                <tbody>
                    ...
                    <tr style="font-size:14px;" <?php
                       ...
                       <td><?= $no++;?></td>
                        ...
                        <?php 
                        echo "<br>" .
                        $data['pelanggan'] . " HP : <a style=\"font-size:12px;\" href='https://wa.me/62" . $data['no_hp'] . "'>0". $data['no_hp'] ."</a><br>" ;
                        ?>
                        <?= $data['alamat'];
                            ...
                            where nama_barang = '$barang'");
                                ...
                                <?php } ?> -->
                                    ...
                                    <div   class='text-start' style="font-size:12px; padding-right:40">
                                     ...
                                     Total : Rp. <?=(number_format(array_sum($total_bayar))) ?> <br>
                                     <? echo "<b>Tgl Fix Kirim : ".$data['tgl_kirim_fix']."</b>";?> <br>
                                     <? echo "<b>Catatan : ".$data['keterangan']."</b>";?></div>


                                     <a href="https://ciwideyfood.com/app/penjualan/wa.php?no_inv=<?= $data['no_inv'] ?>&massa=<?= $tomas ?>"
                                        class="btn btn-sm   btn-success material-icons ">send</a>
