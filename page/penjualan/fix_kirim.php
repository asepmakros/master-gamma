...
<table class="table table-sm table-striped order-warning display mt-2" id="myTable" border="1" >
    ...
    <tbody >
        <?php 
          ...
          where produk != ' Ongkir' and produk != 'DISKON'
          and tgl_kirim_fix = '0000-00-00'
          group by no_inv
          order by id desc 
          limit 500
         ");
